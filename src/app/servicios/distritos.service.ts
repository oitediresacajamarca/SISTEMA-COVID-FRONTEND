...
export class DistritosService {
  ...
  devolverDistritos(codprov:String){
    return this.http.get<any>(environment.urlTalend+'distritos/provincia/'+codprov);
  }
  devolverCP(coddist:string){
    return this.http.get<any>(environment.urlTalend+'centrospoblados/distrito/'+coddist);
  }
